...
/** London Bridge Partition **/
struct note partition [] =
{
		{SOL4, 6},
		{LA4, 2},
		{SOL4, 4},
 ...
 *
 * @note_playing	The note played from the partition
 **/
...
void PlayMusic()
{
	int length = sizeof(partition) / sizeof(partition[0]);
...
/** Interruption for the microphone **/
